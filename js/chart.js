...
const Chart = (() => {
  ...
  const POOLS = {
    easy: {
      ...
      chorus: [
        [[0,'J','n'],[1,'K','n'],[2,'J','n'],[3,'K','n']],
        [[0,'U','n'],[1,'U','n'],[2,'I','n'],[3,'I','n']],
        [[0,'J','n'],[1,'K','n'],[2,'I','n']],
        [[0,'J','h',2],[2,'K','n'],[3,'I','n']],
        [[0,'K','n'],[2,'U','n'],[3,'I','n']],
      ],
    ...
    normal: {
      verse: [
        [[0,'J','n'],[1,'K','n'],[2,'J','n'],[3,'K','n']],
        [[0,'K','n'],[1,'I','n'],[2,'J','n'],[3,'U','n']],
        [[0,'J','n'],[0.5,'K','n'],[2,'J','n'],[2.5,'K','n']],
        [[0,'U','n'],[1,'I','n'],[2,'U','n'],[3,'I','n']],
        [[0,'J','h',2.5]],
        [[0,'J','n'],[1,'J','n'],[2,'K','n'],[3,'I','n']],
        [[0,'K','n'],[1,'J','n'],[2,'I','n'],[3,'K','n']],
        [[1,'J','n'],[2,'K','n'],[3,'U','n']],
      ],
      chorus: [
        [[0,'J','n'],[1,'K','n'],[1.5,'J','n'],[2,'K','n'],[3,'I','n']],
        [[0,'U','n'],[0.5,'I','n'],[2,'J','n'],[2.5,'K','n'],[3,'I','n']],
        [[0,'J','n'],[1,'K','n'],[2,'I','h',1.5]],
        [[0,'I','n'],[1,'I','n'],[2,'J','n'],[2.5,'K','n'],[3,'U','n']],
        [[0,'J','h',1.5],[2,'K','n'],[3,'I','n']],
        [[0,'K','n'],[1,'I','n'],[2,'J','n'],[3,'K','n'],[3.5,'I','n']],
      ],
    },
    hard: {
      verse: [
        [[0,'J','n'],[0.5,'K','n'],[1,'J','n'],[2,'U','n'],[2.5,'I','n'],[3,'U','n']],
        [[0,'K','n'],[1,'I','n'],[1.5,'K','n'],[2,'J','n'],[3,'K','n'],[3.5,'I','n']],
        [[0,'J','h',3.5]],
        [[0,'I','h',3.5]],
        [[0,'J','n'],[0,'K','n'],[1.5,'U','n'],[2,'I','n'],[2.5,'U','n'],[3.5,'K','n']],
        [[0,'U','n'],[1,'J','n'],[2,'I','n'],[3,'K','n'],[3.5,'J','n']],
      ],
      chorus: [
        [[0,'J','n'],[0.5,'K','n'],[1,'J','n'],[1.5,'K','n'],[2,'U','n'],[2.5,'I','n'],[3,'U','n'],[3.5,'I','n']],
        [[0,'J','h',1.5],[2,'K','h',1.5]],
        [[0,'I','n'],[0.5,'U','n'],[1,'I','n'],[2,'J','n'],[2.5,'K','n'],[3,'J','n'],[3.5,'K','n']],
        [[0,'K','n'],[1,'J','n'],[1.5,'K','n'],[2,'I','n'],[3,'U','n'],[3.5,'I','n']],
        [[0,'J','n'],[1,'I','h',2],[3,'K','n'],[3.5,'J','n']],
        [[0,'U','n'],[0.5,'J','n'],[1,'I','n'],[2,'K','n'],[2.5,'J','n'],[3,'I','n'],[3.5,'K','n']],
      ],
    },
  };
  const OUTRO = [
  ...
  function generate(song, diffKey) {
    ...
    for (let bar = 4; bar < BARS; bar++) {
      for (const off of [1.5, 2.5, 3.5]) {
        ...
        const lane = 'JKUI'[Math.floor(Math.random() * 4)];
